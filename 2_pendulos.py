...
file_in_2 = "0_21.dat"
file_out = "1" # Nombre del fichero de salida (sin extensión)
...
for planet_pos, radius in zip(frames_data_2[0], planet_radius):
    ...
    planet_points = planet_points + planet_points_2
    
    line, = ax.plot([], [], "-", color="red")
    line2, = ax.plot([], [], "-", color="red")
    line3, = ax.plot([], [], "-", color="blue")
    line4, = ax.plot([], [], "-", color="blue")
...
def update(j_frame, frames_data, planet_points, planet_trails, show_trail):
    ...
    return planet_points + planet_trails + [line] + [line2] + [line3] + [line4] 
